...
\secc Řízení rychlosti

Pro řízení rychlosti motoru byl v rámci testovaci aplikace navržen jednoduchý PI regulátor pomocí nástroje {\em rltool} z prostředí MATLAB. Naměřené průběhy této regulace jsou uvedeny v sekci \ref[zazn_test_sec].
...
Detail průběhů napětí a proudů z~obrázku \ref[prubehy_pwma1_obr] je na obrázku \ref[prubehy_pwma2_obr].
 Z~tohoto obrázku je také patrné, že jeden z měřených proudů má o~něco menší zesílení (suma změřených proudů není nulová). Následná unalýza ukázala jako pravděpodobné, že při měření proudů dochází k~nežádoucímu magnetickému rušení.
