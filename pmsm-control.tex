...
V~rámci testovací aplikace je implementováno poziční řízení s~P regulátorem a řízení rychlosti s~využitím PI regulátoru. Průběžné hodnoty rychlosti, měřených proudů a šířek plnění PWM jsou vzorkovány jednou za 2 cyly řídicí smyčky. Následně jsou uloženy do souboru "logs.log" a v~textové formě zpracovány v~programu MATLAB. Na obrázku  \ref[t_prubehy_1] je odezva systému na změnu pevně volené šířky plnění z~0 na 100.
 \medskip \clabel[t_prubehy_1]{Záznam průběhu při odezvě na změnu pevné šířky plnění}
\picw=16cm \cinspic duty100_step.pdf
\caption/f Záznam průběhu při odezvě na změnu pevné šířky plnění. Konfigurace duty:1000.
\medskip 
Na obrázku \ref[t_prubehy_2] je zaznamenán průběh řízení rychlosti. Konkrétně pak odezva na změnu požadované rychlosti z~0 na 100. Obrázek \ref[t_prubehy_3] pak zachycuje řízení rychlosti na hodnotu 100 s~postupně se zvyšující zátěží.
