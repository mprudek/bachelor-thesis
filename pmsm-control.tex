...
Tento postup se opakuje až do deaktivace signálu "SE".
 ...
 Jako první je třeba nastavit mód SPI, to je provedeno s~kódem operace "SPI_IOC_WR_MODE" následovně:
  \begtt
 ...
 ret = ioctl(fd, SPI_IOC_WR_MAX_SPEED_HZ, &speed);\endtt
  ...
  Nyní je zařizení SPI plně nakonfigurováno a může začít přenos dat. Nejdrříve je nutné nastavit parametry specifické pro daný přenos, vyplnit ukazatel na úsek paměti s výstupními daty ("tx") a ukazatel na oblast připravenou pro uložení vstupních dat ("rx").Ten je proveden z~využitím struktury "spi_ioc_transfer":
  \ttline+9 
  \begtt
